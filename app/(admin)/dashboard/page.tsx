        ...
        <section className="grid gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-2xl bg-zinc-800/50 p-6 backdrop-blur-sm border border-zinc-700/50">
            <div className="mb-4 flex items-center justify-between">
              ...
              <Link href="/dashboard/orders" className="text-sm font-medium text-blue-400 hover:text-blue-300 transition-colors">
                View All →
              </Link>
            </div>
          ...
          <div className="rounded-2xl bg-zinc-800/50 p-6 backdrop-blur-sm border border-zinc-700/50">
            <div className="mb-4 flex items-center justify-between">
              ...
              <Link href="/dashboard/sessions" className="text-sm font-medium text-blue-400 hover:text-blue-300 transition-colors">
                View All →
              </Link>
            </div>
